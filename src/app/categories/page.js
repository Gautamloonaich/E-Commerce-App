  ...
  return (
    <>
      <div className="mt-[80px] w-full">
        <div className=" pt-2 pb-30 mt-30 sm:pb-20 px-2  sm:px-6 md:px-16 lg:px-18 xl:px-27 space-y-3 sm:space-y-4 md:spce-y-5 lg:space-y-6 xl:space-y-8">
          <h1 className=" font-bold text-2xl lg:text-3xl sm:text-start text-center text-neutral-900 mb-2 ">
            Browse Categories
          </h1>
          <p className="text-neutral-600 text-lg sm:text-start text-center">
            Discover products organized by category
          </p>
          <div className="flex items-center justify-between gap-2 mt-5 mb-3">
            <p className="text-sm md:text-lg pl-3 font-light">
